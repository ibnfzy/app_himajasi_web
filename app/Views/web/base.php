...
<head>
  ...
  <title>Himpunan Mahasiswa Jurusan Sistem Informasi</title>
  <!-- Font Awesome -->
...
<body>
  ...
  <header>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-2" style="z-index: 9999; width: 100%;" id="navbar">
      <div class="container-fluid">
        <!-- Navbar brand -->
        <a class="navbar-brand nav-link" target="_blank" href="https://mdbootstrap.com/docs/standard/">
          <img src="/logo.png" height="40" alt="MDB Logo" loading="lazy" class="me-2" /> HIMAJASI
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarExample01">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Struktural Organisasi</a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Sejarah HIMAJASI</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="#">Tentang HIMAJASI</a>
            </li>
          </ul>
    ...
    <!-- Carousel wrapper -->
    <div id="carouselBasicExample" class="carousel slide carousel-fade p-3" data-mdb-ride="carousel" data-mdb-carousel-init>
      <!-- Indicators -->
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          <img src="/uploads/f.jpg" class="d-block w-100" />
  ...
  <footer class="bg-light text-lg-start">
    <div class="py-4 text-center">
      <a role="button" class="btn btn-primary btn-lg m-2" data-mdb-ripple-init href="https://www.youtube.com/channel/UC5CF7mLQZhvx8O5GODZAhdA" rel="nofollow" target="_blank">
        Learn Bootstrap 5
      </a>
    ...
    <div class="text-center py-4 align-items-center">
      ...
      <a href="https://www.youtube.com/channel/UC5CF7mLQZhvx8O5GODZAhdA" class="btn btn-primary m-1" data-mdb-ripple-init role="button" rel="nofollow" target="_blank">
        <i class="fab fa-youtube"></i>
      </a>
      <a href="https://www.facebook.com/mdbootstrap" class="btn btn-primary m-1" data-mdb-ripple-init role="button" rel="nofollow" target="_blank">
        <i class="fab fa-facebook-f"></i>
      </a>
      <a href="https://twitter.com/MDBootstrap" class="btn btn-primary m-1" role="button" rel="nofollow" target="_blank">
        <i class="fab fa-twitter"></i>
      </a>
      <a href="https://github.com/mdbootstrap/mdb-ui-kit" class="btn btn-primary m-1" data-mdb-ripple-init role="button" rel="nofollow" target="_blank">
        <i class="fab fa-github"></i>
      </a>
    </div>
